...
import { Search, TrendingUp, Calendar, Award, Clock, ChevronRight } from 'lucide-react';
...
const AssessmentContent = () => {
    ...
    const assessments = [
        ...
        topics: 'Respiratory & Cardiovascular Care',
        progress: 40,
        },
    ...
    const yourAssessments = [
        ...
        subtitle: 'Title: Urine Production and Renal Regulation',
        description: 'Description: Working through a case of persistent cough and fever, learners key findings that distinguish community-acquired pneumonia from other lung infections.',
        author: 'By Dr. Gregory Lewis',
        date: 'May 6, 2025',
        },
        // ... (Giữ nguyên dữ liệu cũ của bạn) ...
        {
        ...
        subtitle: 'Title: Diagnosing Pneumonia - Clinical CT',
        description: 'Description: Working through a case of persistent cough and fever, learners key findings that distinguish community-acquired pneumonia from other lung infections.',
        author: 'By Dr. Lisa Margaret',
        date: 'May 6, 2025',
        },
        {
        category: 'All Courses',
        ...
        subtitle: 'Title: Chest Pain and Cardiac Risk Evaluation',
        description: 'Description: Assess a patient presenting with chest pain and shortness of breath. Learn to differentiate between myocardial infarction, angina, and heart failure.',
        author: 'By Dr. Michael Reed',
        date: 'May 6, 2025',
        },
    ];
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <p className="text-gray-600">Test your knowledge with interactive assessments designed for medical learners.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition">
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-sm text-gray-600 mb-1">{assessment.id} • {assessment.level} • {assessment.cases}</div>
                    </div>
                    </div>
                    <div className="p-6">
                    <h3 className="font-bold text-gray-800 mb-2">{assessment.title}</h3>
                    <p className="text-sm text-gray-600 mb-4">{assessment.topics}</p>
                    <div className="mb-4">
                        <div className="flex justify-between text-sm mb-1">
                        <span className="text-gray-600">Progress</span>
                        <span className="font-semibold text-[#235697]">{assessment.progress}%</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="bg-[#235697] h-2 rounded-full" style={{ width: `${assessment.progress}%` }}></div>
                        </div>
                    </div>
                    <button className="w-full bg-[#235697] text-white py-2 rounded-lg font-semibold hover:bg-[#1d4577] transition flex items-center justify-center gap-2">
            ...
            <div className="space-y-4">
                {yourAssessments.map((assessment, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md p-6 flex gap-6 hover:shadow-lg transition">
                    ...
                    <button className="px-6 py-2 bg-[#2AA8D8] text-white rounded-lg font-semibold hover:bg-[#2597c4] transition whitespace-nowrap h-fit">
                        Start Now
                    </button>
                    </div>
                </div>
